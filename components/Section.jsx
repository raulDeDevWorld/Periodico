...
export default function Section({ topic, publicView }) {
    ...
    //console.log(userDB)
    //console.log(userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear])

    return (
        <>
            {userDB[monthAndYear] !== null && publicView == false && <Form topic={topic} value={userDB[`${topic}-${date}`]}></Form>}
            {userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear] == "TemplateOne" &&
                <TemplateOne topic={topic}
                  ...
                  {userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear]  == "TemplateThreeA" &&
                <TemplateThreeA topic={topic}
                    ...
                    />}
                 {userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear]  == "TemplateThreeB" &&
                <TemplateThreeB topic={topic}
                    ...
                    objectPosition3={userDB[`${topic}-objectPosition-Post3-${date}`]}
                    />}
            {userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear] == "TemplateFour" &&
                ...
                />}
            {userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear]  == "TemplateFive" &&
            ...
            {userDB[monthAndYear] && userDB[monthAndYear][topic]  && userDB[monthAndYear][topic]['Templates'] && userDB[monthAndYear][topic]['Templates'][dayMonthYear] == "TemplateSix" &&
